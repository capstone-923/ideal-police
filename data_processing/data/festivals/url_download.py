...
def allDatasetsFestival():
    """
    Retrieves metadata for the "festivals-events" dataset and its resources 
    from the Toronto Open Data Portal and saves the metadata in a JSON file.
